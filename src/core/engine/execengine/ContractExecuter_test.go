...
func PrintContract(v_contract *contract.CognitiveContract) {
	...
	fmt.Println("OperateTime: ", v_contract.ContractHead.OperateTime)
	fmt.Println("  PropertyTable[_OperateTime]: ", v_contract.GetPropertyTable()["_OperateTime"])
	fmt.Println("AssignTime: ", v_contract.ContractHead.AssignTime)
	fmt.Println("  PropertyTable[_AssignTime]: ", v_contract.GetPropertyTable()["_AssignTime"])
